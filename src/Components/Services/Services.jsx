        ...
        <div className=" grid grid-cols-1 lg:grid-cols-3 gap-3">
...

          {
            services.map((service,index)=>{
              return(
                <div key={index} className="lg:w-80 border-2 hover:border-purple-500 hover:bg-gradient-to-r  from-[#3f0028] to-[#582300] transition hover:scale-105 rounded-lg pl-3 pr-8 py-4 ">
